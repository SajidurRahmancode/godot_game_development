...
const Builtins = preload("res://addons/dialogue_manager/utilities/builtins.gd")
...
const DialogueManagerParser = preload("res://addons/dialogue_manager/components/parser.gd")
const DialogueManagerParseResult = preload("res://addons/dialogue_manager/components/parse_result.gd")
